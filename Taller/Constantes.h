...
const double pi2       = 2.0*3.14159265358979324;              // 2pi
const double Rad       = 3.14159265358979324 / 180.0;          // Radians per degree
const double Deg       = 180.0 / 3.14159265358979324;          // Degrees per radian
const double Arcs      = 3600.0*180.0/3.14159265358979324;     // Arcseconds per radian
...
const double GM_Moon     = 398600.4418e9/81.3005869999999931; // [m^3/s^2]; DE200
...
const double GM_JuM_PIter  = 126712597.0817946e9;          // [m^3/s^2]; DE200
