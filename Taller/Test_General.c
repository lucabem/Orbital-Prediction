...
void Test_AngleDr()
{
    ...
    assert( fabs(  1000*(r2[0]/1000 - 8794.27658098403)< 0.01));
    assert( fabs(  1000*(r2[1]/1000 - 404.708194943489))< 0.01);
    assert( fabs(  1000*(r2[2]/1000 - 2543.97380563715))< 0.01);

    assert( fabs(  1000*(v2[0]/1000 - 0.591415680079019)< 0.01));
    assert( fabs(  1000*(v2[1]/1000 - 5.83886365198696))< 0.01);
    assert( fabs(  1000*(v2[2]/1000 + 2.98863988398241)) < 0.01);
