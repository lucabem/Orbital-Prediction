...
void Example3()
{
    ...
    long double lat = RAD*30.5724;     // [rad]
    long double lon = RAD*(-86.2143); // [rad]
    long double alt = 0.0;     // [m]
    ...
    printf("\n RESULTADO FINAL EXAMPLE 3 Double-R-Iteration method\n");

    long double errorR2[3] = { 40706.1757963811, 9894.89554171767 , -235.153903192033};
    long double errorVV2[3] = { -0.717462813807556, 2.96769999408282 , 0.00324067616543317};
/*
    printf("\t%0.5f ------- %0.5f \n ", r2[0]/1000, errorR2[0]);
    printf("\t%0.5f  ------- %0.5f \n ", r2[1]/1000, errorR2[1]);
    printf("\t%0.5f ------- %0.5f \n ", r2[2]/1000, errorR2[2]);
