             ...
             )
{
    ...
    else
    {
     ...
     double rho3 = -dot(3, rsite3, w) / dot(3, los3, w);
    ...
    else
    {
     ...
     double n, s, c, sinde32, cosde32, deltae32,
    ...
    else
    {
     ...
     double q1 = sqrt(pow(f1,2) + pow(f2,2));
